...
class configHandler:
    ...
    def generateConfigFile(self):
        try:
            ...
            write_config.set("cassandra", "BUNDLE", "CassandraDataStraxPythonBundle\\secure-connect-test1.zip")
            write_config.set("cassandra", "CLIENT_ID","zHIHPnrSNbfZZbXkMPQUDYPb")
            write_config.set("cassandra", "CLIENT_SECRET", "UH-EuKwc1AGut2.fk764xTF3yPXzi3-BpxADgt8v0j-kZYXIiUPTNhY7ul3L8phhG,m7efBlm_rHr_k7NB0YvZcRbfMUurh5tNXQTqzoIlHtkgfBGC,zLAPhKPRjsEbk")
            write_config.set("cassandra", "KEY_SPACE", "ineuron")
